...
public class InjectionController extends ArrayList<Injection> implements FileConnection<Injection> {
	...
	public void saveToFile() {
		...
		for (Injection injection : this) {
			printWriter.println(injection.getSecondPlace() == null
					? injection.getInjectionID() + "|" + injection.getStudentID() + "|" + injection.getVaccineID() + "|"
							+ injection.getFirstPlace() + "|" + dateFormat.format(injection.getFirstDate()) + "|" + "none" + "|"
							+ "none"
					: injection.getInjectionID() + "|" + injection.getStudentID() + "|" + injection.getVaccineID() + "|"
							+ injection.getFirstPlace() + "|" + dateFormat.format(injection.getFirstDate()) + "|"
							+ injection.getSecondPlace() + "|" + handleSecondDateFormat(injection.getSecondDate()));
		}
	...
	private String handleSecondDateFormat(Date secondDate) {
		return secondDate == null ? "none" : dateFormat.format(secondDate);
	}
